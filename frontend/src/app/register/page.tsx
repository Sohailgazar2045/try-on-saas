...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0a0a0b]">
      {/* Left Panel - Visual */}
      <div className="hidden lg:flex flex-1 items-center justify-center bg-[#111113] border-r border-white/[0.06] p-12">
        <div className="max-w-lg">
          ...
          <h2 className="text-3xl font-bold text-white">Start creating stunning<br />try-on visuals today</h2>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">CEO, FashionTech Co</p>
              </div>
            </div>
          </div>
        </div>
